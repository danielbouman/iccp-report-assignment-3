...
\end{figure} Figure \ref{fig:crosssection} shows a cross-section along the x-axis at $y = 26.5$, $t = 60$, $\tau = 0.1$ of the probability distribution is seen figure \ref{fig:doubleslit}. $t=60$ corresponds rougly to the \nth{9} snapshot. The probability distribution is again normalized to find the conditional distribution.
\begin{Figure}
    \centerfloat
